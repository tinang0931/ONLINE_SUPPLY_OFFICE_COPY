...
urlpatterns = [ 
   ...
   # path('cdppmp_approval/<int:your_id>/preqform_cd.html', views.cd_ppmp_approval, name='cd_ppmp_approval'),
   ...
   path('bac_home/',views.bac_home, name='bac_home'),
   path('cdppmp_approval/<int:pr_id>/', views.cdppmp_approval, name='cdppmp_approval'),
