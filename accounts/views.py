...
def submit_request(request):
    ...
    if request.method == 'POST':
        ...
        purchase_request = PurchaseRequestForm.objects.create(request_number=request_id, status='Waiting for Campus Director Approval')
...
def receive_request(request):
    ...
    if request.method == 'POST':
        request_id = request.POST.get('request_id')
        purchase_request = get_object_or_404(PurchaseRequestForm, request_number=request_id)
